...
const securityHeaders = [
  ...
  // Report-Only first: enforce only after verifying Next/Supabase/Whop/hCaptcha/Pipedream.
  {
    ...
    value: [
      "default-src 'self'",
      "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://js.hcaptcha.com https://*.hcaptcha.com https://js.whop.com https://*.whop.com",
      "style-src 'self' 'unsafe-inline' https://*.hcaptcha.com",
      "img-src 'self' data: blob: https:",
      "font-src 'self' data:",
      "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://*.whop.com https://*.hcaptcha.com https://*.pipedream.com https://api.pipedream.com https://*.stack32.com https://stack32.com",
