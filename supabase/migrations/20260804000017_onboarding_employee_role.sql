-- Allow "employee" (salarié) as an onboarding role.

alter table public.onboarding_responses
  drop constraint if exists onboarding_responses_role_check;

alter table public.onboarding_responses
  add constraint onboarding_responses_role_check check (
    role in (
